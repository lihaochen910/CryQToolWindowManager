...
class CCollapsibleFrameHeader ( QWidget ):
	...
	def __init__ ( self, title, parentCollapsible, icon, bCollapsed ):
		...
		collapsedPixmap = QPixmap ( "./resources/icons/window_collapse_arrow_right_tinted.ico" )
		...
		expandedPixmap = QPixmap ( "./resources/icons/window_collapse_arrow_down_tinted.ico" )
