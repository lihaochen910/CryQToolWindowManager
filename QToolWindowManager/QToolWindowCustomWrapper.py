...
class QToolWindowCustomWrapper ( QCustomWindowFrame ):
	...
	def moveEvent ( self, e ):
		...
		# if self.titleBar and self.manager:
	...
	def mousePressEvent ( self, e ):
		# if self.titleBar and e.buttons () == Qt.LeftButton:
		# 	if self.manager:
		# 		self.dragCanStart = True
		# 		self.manager.startDragWrapper ( self )
	...
	def mouseMoveEvent ( self, e ):
		# if self.titleBar and self.manager and self.dragCanStart:
		# 	if self.manager.draggedWrapper == self:
		# 		self.manager.updateDragPosition ()
		# 	else:
		# 		self.manager.startDragWrapper
		if self.titleBar and self.createdFromDrag:
			qApp.sendEvent ( self.titleBar, e )
			qWarning ( "wrapper createdFromDrag mouseMoveEvent" )
